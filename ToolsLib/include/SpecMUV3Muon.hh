...
public:
  ...
  SpecMUV3Muon();
  SpecMUV3Muon(Int_t, Double_t, Double_t, Double_t, Double_t);
  SpecMUV3Muon(Int_t, Double_t, Double_t, TVector2);
  SpecMUV3Muon(Int_t, Double_t, Double_t, Double_t, Double_t, std::vector<SpecMUV3AssociationRecord>);
  SpecMUV3Muon(Int_t, Double_t, Double_t, TVector2, std::vector<SpecMUV3AssociationRecord>);
...
private:
  ...
  Double_t fTrackTime;    ///< Track time
  ...
  std::vector<SpecMUV3AssociationRecord> fAssociationRecordContainer; ///< Records of each matching MUV3 candidate
};
