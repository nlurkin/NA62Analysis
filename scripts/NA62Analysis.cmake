...
if(CMAKE_COMPILER_IS_GNUCXX)
	...
	if(${NA62USE_USER})
		message("Try $ENV{ANALYSISFW_USERDIR}/build/test ${NA62ANALYSIS}/scripts/test_unordered_map.cpp")
		try_compile(TEST_UN_MAP $ENV{ANALYSISFW_USERDIR}/build/test ${NA62ANALYSIS}/scripts/test_unordered_map.cpp)
	else ()
		message("Try ${NA62ANALYSIS}/build/test ${NA62ANALYSIS}/scripts/test_unordered_map.cpp")
